...
const WorkPlace = () => {
  return (
    <div className="w-full h-[65vh] lg:h-[100vh] xl:h-[85vh] px-[5vw] mt-10 lg:mt-15 xl:pt-25 ">
      <div className="w-full">
        <h1 className="text-center text-nowrap text-[6.5vw] lg:text-[5vw] xl:text-[3vw] font-light">
          Our Sucessful <span className="font-semibold">work & Plant</span>
        </h1>
        <p className="text-center lg:text-[1.7vw] xl:text-[22px] mt-5 ">
      ...
      <div className="w-full h-[40vh] lg:h-[60vh] xl:h-[48vh] lg:mt-20 bg-[url('/Slicing/Workplace/back-image-workspace.jpg')] bg-no-repeat bg-cover object-center bg-left lg:bg-center ">
        <div className="flex justify-center">
          <div className=" text-center w-[85vw] lg:w-[60vw] xl:w-[43vw] bg-[#FFFFFF] flex items-center justify-center rounded-full drop-shadow-xl py-1 pl-5 pr-1 lg:py-2 lg:pl-9 lg:pr-2 mt-15 xl:mt-20 ">
            <input
              type="text"
              id="places"
        ...
        <div>
          <div className="px-[6.5vw] mt-10 xl:mt-20 ">
            {/* card */}
